...
export default function Index() {
  ...
  const url =
    "https://newsapi.org/v2/everything?q=apple&from=2024-09-10&to=2024-09-10&sortBy=popularity&apiKey=3accc672c1e34e26a3df9b278e09dabe";
